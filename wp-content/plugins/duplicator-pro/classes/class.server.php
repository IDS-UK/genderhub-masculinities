	...
	*/
	public static function get_orphaned_package_files() 
	{
		...
		if(defined('GLOB_BRACE'))
		{
			...
			$filepaths = glob(DUPLICATOR_PRO_SSDIR_PATH . "/" . "*_{archive,database,scan,$installer_base_name,$legacy_installer_filename}*", GLOB_BRACE);
	...
	*/
	public static function get_installer_files() 
	{
		...
		if($global == null)
		{
			...
			$legacy_installer_filename = 'installer-legacy.php';
		}
		else
		{
		...
		return array(
			...
			$legacy_installer_filename => DUPLICATOR_PRO_WPROOTPATH . $legacy_installer_filename, 
